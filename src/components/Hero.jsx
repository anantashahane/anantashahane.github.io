...
const Hero = () => {
    return (
        ...
        <div className="absolute lg:inset-x-5 inset-x-0 bottom-0 z-10 p-4 lg:p-8 border-t-[1px] border-white/20 backdrop-blur-sm rounded-t-3xl bg-gradient-to-t from-zinc-900 to-zinc-900/10 flex flex-col items-center justify-center text-center reveal-up">
